...
public class OptionRadioAdapter extends RecyclerView.Adapter<OptionRadioAdapter.OptionHolder>{

    ArrayList<OptionModel> dataOption;
    Context context;
    OptionRadioAdapter.OnItemClicked Handler;
    AppDatabase db;
    Session session;
    ...
    public OptionRadioAdapter(Context context) {
        this.context = context;
    }

    public void setHandler(OptionRadioAdapter.OnItemClicked clickHandler) {
        this.Handler = clickHandler;
    }

    @NonNull
    @Override
    public OptionRadioAdapter.OptionHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.option_item, parent, false);
        return new OptionRadioAdapter.OptionHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final OptionRadioAdapter.OptionHolder holder, final int position) {
